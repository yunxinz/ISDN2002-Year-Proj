...
MainWindow::MainWindow(QApplication *app, rviz_common::ros_integration::RosNodeAbstractionIface::WeakPtr rviz_ros_node, QWidget *parent)
    ...
    connect(startButton, &QPushButton::clicked, this, &MainWindow::navigateToSelectedWaypoint);
...
geometry_msgs::msg::Quaternion create_quaternion(double x, double y, double z, double w) {
...
void MainWindow::navigateToSelectedWaypoint() {
    ...
    qDebug() << "Navigating to waypoint:" << QString::fromStdString(waypoint.title);
...
void MainWindow::loadWaypoints() {
    ...
    waypoints_ = {
        {"Waypoint 1", create_point(1.0, 2.0, 0.0), create_quaternion(0.0, 0.0, 0.0, 1.0)},
        {"Waypoint 2", create_point(3.0, 4.0, 0.0), create_quaternion(0.0, 0.0, 0.0, 1.0)},
        {"Waypoint 3", create_point(5.0, 6.0, 0.0), create_quaternion(0.0, 0.0, 0.0, 1.0)}
    };
